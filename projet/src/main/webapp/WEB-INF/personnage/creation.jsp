...
<form class="form-horizontal col-sm-offset-3" method="post" action="character?action=create">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="naissance" name="naissance" placeholder="Naissance" value="<c:out value="${param.naissance}"/>" required/>
    </div>
  </div>
  <div class="form-group">
    <label for="profession" class="col-sm-3 control-label">Profession</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="profession" name="profession" placeholder="Profession" value="<c:out value="${param.profession}"/>" required/>
    </div>
  </div>
  <div class="form-group">
    <label for="portrait" class="col-sm-3 control-label">URL du portrait</label>
    <div class="col-sm-7">
      <input type="text" class="form-control" id="portrait" name="portrait" placeholder="URL du portrait" value="<c:out value="${param.portrait}"/>"/>
    </div>
  </div>
  <div class="form-group">
    <label for="biographie" class="col-sm-3 control-label">Biographie initiale</label>
    <div class="col-sm-7">
      <textarea class="form-control" rows="7" id="biographie" name="biographie" placeholder="Biographie initiale" required><c:out value="${param.biographie}"/></textarea>
    </div>
  </div>
